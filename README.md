# [NDN](https://www.caida.org/publications/papers/2014/named_data_networking/named_data_networking.pdf)（Named Data Networking）のCS内を実装したファイル群 (A set of files that implements CS(Contents Store) of NDN)
